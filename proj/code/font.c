...
char Font_Load(){
	...
	fonts[FONT_BIG].fontImg = LoadBitmapFile("home/lcom/lcom1516-t6g05/proj/img/texto.bmp", &info);
	...
	fonts[FONT_NORMAL].fontImg = LoadBitmapFile("home/lcom/lcom1516-t6g05/proj/img/fontnormal.bmp", &info);
