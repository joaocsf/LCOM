...
void TDS_Init(){
	...
	TM_AddTexture(SI_PLAYER,"home/lcom/lcom1516-t6g05/tds/img/bluebirdSheet.bmp");
	TM_AddTexture(SI_PLAYER2,"home/lcom/lcom1516-t6g05/tds/img/redbirdsheet.bmp");
	TM_AddTexture(SI_BULLET,"home/lcom/lcom1516-t6g05/tds/img/bullet.bmp");
	TM_AddTexture(SI_ENEMY,"home/lcom/lcom1516-t6g05/tds/img/wormSheet.bmp");
	TM_AddTexture(SI_ENEMY2,"home/lcom/lcom1516-t6g05/tds/img/robot.bmp");

	TM_AddTexture(SI_EXPLOSION,"home/lcom/lcom1516-t6g05/tds/img/explosion.bmp");

	TM_AddTexture(SI_MAP,"home/lcom/lcom1516-t6g05/tds/img/tileset.bmp");
	Font_Load();
	menu = MainMenu_Create("home/lcom/lcom1516-t6g05/tds/img/mainMenuTest.bmp");
...
Player * GameLogicInit(){
	...
	Map_Init("home/lcom/lcom1516-t6g05/tds/img/tileset.bmp", mapWitdh,mapHeight);
	Map_FillBuffer();
...
void MP_GameLogicInit(){
	...
	unsigned int mapHeight = 20;
	Map_Init("home/lcom/lcom1516-t6g05/tds/img/tileset.bmp", mapWidth,mapHeight);
	Map_FillBuffer();
...
int game(){
	...
	UART_SetConfiguration(addr, 3, 2, 7, (unsigned short)114000);
